...
var grammar = {
    ...
    {"name": "statements", "symbols": ["statements", (myLexer.has("NL") ? {type: "NL"} : NL)], "postprocess": 
        (data) => {
            return [...data[0], data[2]];
        }
                },
    {"name": "statements", "symbols": [(myLexer.has("NL") ? {type: "NL"} : NL)]},
    ...
    {"name": "arg_list", "symbols": ["arg_list", (myLexer.has("coma") ? {type: "coma"} : coma), "expr"], "postprocess": 
        (data) => {
            return [...data[0], data[2]];
        }
                },
    ...
    {"name": "expr", "symbols": ["var_nameAssign"], "postprocess": id},
    {"name": "expr", "symbols": ["fun_call"], "postprocess": id},
    {"name": "var_nameAssign", "symbols": [(myLexer.has("identifier") ? {type: "identifier"} : identifier)], "postprocess": id},
